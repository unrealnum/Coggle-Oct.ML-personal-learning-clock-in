...
* 3. [TASK 2：比赛数据分析](#TASK2)
	...
	* 3.3. [缺失值观察处理](#-1)
		...
		* 3.3.3. [训练集探索性分析](#-1)
		* 3.3.4. [待检测集探索性分析](#-1)
* 4. [TASK 3：验证集划分与树模型](#TASK3)
	* 4.1. [原始数据集切分操作](#-1)
* 5. [TASK 4：特征工程入门](#TASK4)
* 6. [TASK 5：特征工程进阶](#TASK5)
* 7. [TASK 6：树模型进阶](#TASK6)
* 8. [TASK 7：多折训练与集成](#TASK7)
...
###  3.3. <a name='-1'></a>缺失值观察处理

####  3.3.1. <a name='-1'></a>缺失值观察
...
![](https://github.com//unrealnum//Coggle-Oct.ML-personal-learning-clock-in//raw//main//图层//缺失值显示.png)

**可以看到整体的一个缺失率分布情况：其中CryoSleep的数据丢失占比最大**<br>



####  3.3.2. <a name='-1'></a>缺失值处理
...
####  3.3.3. <a name='-1'></a>训练集探索性分析



####  3.3.4. <a name='-1'></a>待检测集探索性分析
